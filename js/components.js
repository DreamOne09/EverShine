                ...
                <li class="nav-social">
                    ...
                    <a href="https://www.threads.com/@chhubni" target="_blank" rel="noopener noreferrer" class="nav-social-link" aria-label="Threads">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.186 0C5.373 0 0 5.373 0 12.186c0 6.813 5.373 12.186 12.186 12.186 6.813 0 12.186-5.373 12.186-12.186C24.372 5.373 18.999 0 12.186 0zm0 2.163c5.52 0 10.023 4.503 10.023 10.023 0 5.52-4.503 10.023-10.023 10.023-5.52 0-10.023-4.503-10.023-10.023 0-5.52 4.503-10.023 10.023-10.023zm-1.5 4.5c-2.485 0-4.5 2.015-4.5 4.5s2.015 4.5 4.5 4.5c.83 0 1.58-.225 2.235-.618l-1.235-1.235c-.315.21-.675.353-1.06.353-1.105 0-2-.895-2-2s.895-2 2-2c.385 0 .745.143 1.06.353l1.235-1.235c-.655-.393-1.405-.618-2.235-.618zm3 0c-.83 0-1.58.225-2.235.618l1.235 1.235c.315-.21.675-.353 1.06-.353 1.105 0 2 .895 2 2s-.895 2-2 2c-.385 0-.745-.143-1.06-.353l-1.235 1.235c.655.393 1.405.618 2.235.618 2.485 0 4.5-2.015 4.5-4.5s-2.015-4.5-4.5-4.5z"/>
                        </svg>
                    </a>
                </li>
            </ul>
